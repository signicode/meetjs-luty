/**
 * WARNING: USE AT YOUR OWN RISK - no idea if this ain't gonna drop some frogs from the sky or if locus is going to
 * infest vast areas of Minnesota if you use this anywhere else.
 *
 * If you are however - remember this is AGPL - use it, deliver the source to anyone using it.
 */
